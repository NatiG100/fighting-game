class Sprite {
    constructor({position,imgSrc,scale=1,framesMax=1,offset={x:0,y:0},flip=false}){
        this.flip = flip
...
class Fighter extends Sprite{
    ...
    update(){
        super.update();
        this.attackBox.position.x = (this.position.x + this.attackBox.offset.x)*(this.flip?-1:1);
